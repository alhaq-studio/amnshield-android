...
import com.alhaq.amnshield.databinding.ActivityUsageMetricsBinding
import com.alhaq.amnshield.data.AttentionSpanVideoItem
import com.alhaq.amnshield.utils.SavedPreferencesLoader
import com.alhaq.amnshield.utils.TimeTools
import com.alhaq.amnshield.views.CustomMarkerView
import java.io.File
...
class UsageMetricsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(com.alhaq.amnshield.R.id.main)) { v, windowInsets ->
        ...
        primaryColor = ContextCompat.getColor(
            this,
            com.alhaq.amnshield.R.color.md_theme_primary
        )
        ...
        binding.btnDigiWelbeing.setOnClickListener {
            ...
            if (intent != null) {
                ...
                Snackbar.make(
                    binding.root,
                    getString(com.alhaq.amnshield.R.string.failed_to_launch_system_digital_wellbeing),
        ...
        val markerViewReel = CustomMarkerView(this, com.alhaq.amnshield.R.layout.custom_marker_view)
        ...
        val markerViewAttention = CustomMarkerView(this, com.alhaq.amnshield.R.layout.custom_marker_view)
        ...
        binding.shareStats.setOnClickListener {
            ...
            binding.btnDigiWelbeing.text = getString(com.alhaq.amnshield.R.string.view_more)
        }
    ...
    override fun onResume() {
        ...
        lifecycleScope.launch {
            ...
            binding.statsTodayReels.text =
                getString(com.alhaq.amnshield.R.string.you_scrolled_reels, totalReels.getOrDefault(date, 0))
...
//            }
            ...
            binding.statsAttentionSpanToday.text =
                getString(com.alhaq.amnshield.R.string.you_had_an_attention_span_of_seconds_video, average)
        }
    }
    ...
    private suspend fun makeReelCountStatsChart() {
        withContext(Dispatchers.Default) {
            ...
            val lineDataSet = LineDataSet(entries, getString(com.alhaq.amnshield.R.string.reel_count))
    ...
    private suspend fun makeAverageReelAttentionSpanChart() {
        withContext(Dispatchers.Default) {
            ...
            val lineDataSet = LineDataSet(entries, getString(com.alhaq.amnshield.R.string.average_attention_span))
            // Switch back to the main thread to update the UI
            withContext(Dispatchers.Main) {
                setupChartUI(
